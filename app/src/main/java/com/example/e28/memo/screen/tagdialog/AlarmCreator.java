...
//                    notifyDOW = getNextDOW(notifyDOWList, startDOW, notifiedCount);
//                } else {
//                    // 2週目以降の場合
...
//
//                    int notifiedDOWCount = (notifiedCount - notifiedCountInStartWeek) % notifyDOWCount; // 週2回通知で7回通知済みの場合、1　になる
//                    notifyDOW = getNextDOW(notifyDOWList, 0, notifiedDOWCount); // 通知を行う曜日
//                }
